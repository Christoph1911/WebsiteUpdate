    ...
    return (
      ...
      <p>
        ...
        >
          ...
          <p>
      <a href="mailto:christophpaltzer@gmail.com" style={{margin-left: 100}} ><img src={Mailicon} alt="" /></a>
      <a href="https://github.com/Christoph1911" style={{margin-right: 100}} ><img src={Githubicon} alt="" /></a>
      </p>
          {close}
        </article>
      </div>
